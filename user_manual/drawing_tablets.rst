...
Supporting tablets is the job of the operating system. If the tablet drivers are implemented correctly, and, on Windows, the correct protocol (WinTab/Windows 8 Pointer API) is used, the tablet will work.
